      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-24">
        ...
        <section className="min-h-[50vh] flex flex-col justify-center text-left">
          <AnimateOnScroll>
            <div className="max-w-4xl">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-black leading-tight font-sans">
        ...
        <AnimateOnScroll as="section" className="pt-24">
          <div className="flex justify-between items-end mb-12">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-black font-sans">Featured Work</h2>
              <Link to="/projects" className="text-black hover:text-brand-muted uppercase tracking-wider text-sm font-medium">See All &rarr;</Link>
          </div>
        ...
        <AnimateOnScroll as="section" className="py-24 grid md:grid-cols-2 gap-12 items-center">
          <div className="max-w-md">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-black font-sans">About Me</h2>
              ...
              <div className="mt-8">
                  <Link to="/about" className="text-black hover:text-brand-muted uppercase tracking-wider text-sm font-medium">More about me &rarr;</Link>
              </div>
          </div>
